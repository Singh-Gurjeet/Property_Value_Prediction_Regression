...
saveRDS(sample.df,file=paste0("C:\\Data\\Desktop\\Desktop_Folders\\Gurjeet\\",
                              "Master_Degree\\Course\\Predict 410_55\\Week 3\\",
                              "Assignment 3\\Dataset\\ames_sample.RData"));
...
sample.df <- readRDS(file= paste0("C:\\Data\\Desktop\\Desktop_Folders\\Gurjeet\\",
                                  "Master_Degree\\Course\\Predict 410_55\\Week 3\\",
                                  "Assignment 3\\Dataset\\ames_sample.RData"));
